...
declare var $: any
@Component({
  selector: 'app-rate-exchanger',
  templateUrl: './rate-exchanger.component.html',
  styleUrls: ['./rate-exchanger.component.css']
})
export class RateExchangerComponent implements OnInit {
  ...
  validateFromValue(e) {
    ...
    if (e.target.value == 0) {
      for (let control in this.exchangeForm.controls) {
        this.currencyFromInvalid = true;
      }
    }
  }
