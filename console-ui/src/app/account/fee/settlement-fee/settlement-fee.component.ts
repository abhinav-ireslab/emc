...
declare var $: any
@Component({
  selector: 'app-settlement-fee',
  templateUrl: './settlement-fee.component.html',
  styleUrls: ['./settlement-fee.component.css']
})
export class SettlementFeeComponent implements OnInit {
  ...
  calculatEexchangeFrom() {
    this.exchangeForm.controls['currencyToInput'].setValue((this.exchangeRate * this.exchangeFromInputValue).toFixed(2))
    // this.exchangeToInputValue = (this.exchangeRate * this.exchangeFromInputValue);
  ...
  calculatEexchangeTo() {
    this.exchangeForm.controls['currencyFromInput'].setValue((1 / this.exchangeRate * this.exchangeToInputValue).toFixed(2))
    // this.exchangeFromInputValue = (1 / this.exchangeRate * this.exchangeToInputValue)
    // this.finalRate = (this.exchangeFee * this.exchangeFromInputValue).toFixed(2)
  }
